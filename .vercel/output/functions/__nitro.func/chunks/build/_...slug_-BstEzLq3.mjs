...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "article-wrapper" }, _attrs))} data-v-ea125463>`);
      if (unref(article).image) {
        _push(`<div class="cover-image" style="${ssrRenderStyle({ backgroundImage: `url(${unref(article).image})` })}" data-v-ea125463><h1 class="article-title" data-v-ea125463>${ssrInterpolate(unref(article).title)}</h1></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<article class="article-container" data-v-ea125463><header class="article-header" data-v-ea125463><div class="article-meta" data-v-ea125463><span class="article-date" data-v-ea125463>${ssrInterpolate(formatDate(unref(article).createdAt))}</span></div>`);
      if (unref(article).summary) {
        _push(`<div class="article-summary" data-v-ea125463><p data-v-ea125463>${ssrInterpolate(unref(article).summary)}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</header><div class="article-content" data-v-ea125463>`);
      _push(ssrRenderComponent(_component_ContentDoc, null, null, _parent));
      _push(`<div class="social-share" data-v-ea125463><div class="sharethis-inline-share-buttons" data-v-ea125463></div></div>`);
      _push(ssrRenderComponent(DisqusComments, {
        pageUrl: currentUrl,
        pageIdentifier: unref(article)._path
      }, null, _parent));
      _push(`<a href="https://houedanou.com" rel="dofollow" data-v-ea125463>Jean-Luc Hou\xE9danou</a><br data-v-ea125463><a target="_blank" href="https://jeanluchouedanou.blogspot.com/" data-v-ea125463>Mes anciens articles</a></div><footer class="article-footer" data-v-ea125463>`);
...
const ____slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ea125463"]]);

export { ____slug_ as default };
//# sourceMappingURL=_...slug_-BstEzLq3.mjs.map
