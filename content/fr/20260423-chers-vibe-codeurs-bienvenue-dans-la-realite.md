...
## Le vibe coding, c'est le Bronny James du développement

Le vibe coding, c'est ça. Tu arrives dans le « game » avec un accès privilégié — pas grâce à LeBron, mais grâce à Claude Code, GPT, Copilot. Tu génères du code en tapant des prompts en langage naturel. Tu obtiens un résultat qui a l'air fonctionnel. Tu déploies. 

Tu te présentes comme développeur.

Sauf que ton *welcome to the NBA moment* arrive tôt ou tard. Le jour où le serveur tombe à 23h. Le jour où un audit de sécurité révèle des failles béantes. Le jour où le client demande pourquoi sa base de données fait 40 Go pour 200 utilisateurs. Le jour où tu dois debugger sans IA parce que le problème est trop spécifique pour un prompt.

Ou que tu as épuisé tous les crédits de ton plan.

Et là, comme Bronny face à KD, tu réalises que le niveau réel n'a rien à voir avec ce que tu imaginais.

## Ce que je fais (et ce que je ne fais pas)

Je code depuis plus de dix ans. Je suis passé par Udemy, OpenClassrooms (quand ça s'appelait encore le Site du Zéro), les tutoriels PHP de Grafikart, les nuits blanches sur des segfault sans Stack Overflow. J'ai fait du FTP manuel sur des serveurs mutualisés OVH à 3 euros par mois. J'ai migré des projets de jQuery vers Vue, de Vue 2 vers Vue 3, de Nuxt 2 vers Nuxt 3. J'ai debuggé des conflits de merge à 2h du matin un dimanche. 
...
Je ne regarde ni les Skills, ni les agents. Tout comme ce blog que vous lisez, j'écris d'abord le code moi-même — la structure, la logique, l'architecture — et ensuite je le fais corriger et optimiser par Claude Code. 

**L'IA est mon relecteur, pas mon auteur.** 


Je sais ce que je veux obtenir avant d'ouvrir le terminal. Je sais pourquoi tel middleware est là. Je sais pourquoi telle relation Eloquent est en `hasMany` et pas en `belongsToMany`. Claude Code accélère mon travail. Il ne le remplace pas.

Les vibe coders ? Ils font l'inverse. Ils partent d'un prompt, récupèrent le résultat, ne regardent même pas le code ni sa qualité, et poussent en prod. Ils ne savent pas ce qu'ils ont déployé. Ils ne comprennent pas pourquoi ça marche. 

Et le jour où ça ne marche plus — parce que ce jour arrive toujours — ils sont perdus.

## Les vibe coders sont la plaie de cette profession
...
## Pendant ce temps, chez Anthropic...

Et comme si tout ça ne suffisait pas, Anthropic — la boîte qui fabrique Claude Code — est en train de nous offrir un spectacle édifiant. Un petit résumé du mois d'avril 2026 pour ceux qui ne suivent pas :

**La fuite du code source.** 


Le 31 mars, Anthropic a accidentellement publié l'intégralité du code source de Claude Code via un fichier source map oublié dans un package npm. 500 000 lignes de TypeScript. 1 906 fichiers. En quelques heures, le code était mirroré sur GitHub et forké des dizaines de milliers de fois. 
...
En résumé : fuite de code source vibecodé, performances nerfées, tarification opaque, communication désastreuse. Pour une entreprise qui se vend comme « le labo IA responsable », c'est un sacré coup.

## La barrière à l'entrée, c'est une bonne chose

Voilà. 
Je l'ai dit. Au fond de moi, je pense que c'est une bonne chose qu'il y ait une barrière à l'entrée dans ce métier.

Je refuse de vivre dans un monde où n'importe qui peut coder une application en une journée de travail et prétendre être développeur. Tout comme je refuse de croire que Bronny James mérite sa place en NBA juste parce que son père est LeBron.

La marge de progression existe — pour Bronny comme pour les vibe coders. Bronny peut bosser, améliorer son tir (à 3 points surtout, le petit a vraiment une bonne détente, mais son jumpshot est horrible), travailler sa défense, et devenir un joueur NBA respectable. Les vibe coders peuvent apprendre les fondamentaux, comprendre ce que l'IA génère et devenir de vrais développeurs.

Mais s'ils se contentent d'être là grâce à un avantage qu'ils n'ont pas mérité — le nom de LeBron pour l'un, les prompts de Claude Code pour les autres — sans jamais investir le travail nécessaire pour comprendre le jeu, alors leur carrière finira comme celle de Smush Parker. Oubliée. Anecdotique. Un nom que personne ne retient.

## Et pour nous, les vieux de la vieille ?
...
Aux vibe coders du dimanche : votre *welcome to the NBA moment* arrive. Préparez-vous, ou préparez-vous à être Smush Parker.

Et à Anthropic : ressaisissez-vous. On vous a choisis parce que vous étiez censés être les adultes responsables de cette industrie. 
