...
keywords: "Claude Code, Claude Dispatch, Remote Control, terminal mobile, développement, Anthropic, productivité"
...
Ce workflow est rendu possible par **Claude Dispatch**, ou **Remote Control** selon les versions. Le principe : transformer votre smartphone en télécommande de votre session Claude Code active.
...
**3. Connectez votre téléphone** : ouvrez l'app Claude officielle sur iOS ou Android, rendez-vous dans l'onglet **Code / Dispatch** et retrouvez la session correspondante. Elle est indiquée par un badge vert « connecté ».

C'est tout. Votre session est désormais pilotable depuis votre téléphone.

## Ce qu'il faut savoir avant de se lancer

- **Votre ordinateur doit rester allumé.** Remote Control ne ressuscite pas les sessions mortes. Si votre Mac passe en veille, la connexion tombe.
- **C'est un miroir, pas un agent autonome.** Vous approuvez toujours les changements. Claude Code ne fait rien sans votre accord.
- **Plan requis.** La fonctionnalité est disponible pour les abonnés Max et Pro.

Pour ma part, l'usage reste simple : je n'ai jamais délégué l'écriture de mon code à Claude Code. J'écris d'abord, Claude Code corrige ensuite — pas de skills, pas d'agents, juste mon terminal et moi. Remote Control s'inscrit dans cette logique : je reste aux commandes, depuis n'importe où. Le preview se fait sur la smart TV ou l'iPad, selon la pièce où je me trouve.
