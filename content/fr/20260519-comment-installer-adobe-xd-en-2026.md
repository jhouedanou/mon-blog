...
On va dire les choses proprement : la recommandation officielle du web, c'est souvent « utilise Figma » ou « ouvre ça dans [editor.figpea.com](https://editor.figpea.com/) ». Sur le papier, c’est beau. Dans la vraie vie, quand vous avez un client qui attend un livrable et des calques complexes à inspecter, ce n'est pas toujours aussi fluide.

Puisque Adobe a placé XD en mode maintenance perpétuelle (paix à son âme), voici la méthode réaliste pour les gens qui veulent juste bosser, livrer, et passer à autre chose.
...
Adobe XD, c'est désormais un héritage technique. On l'ouvre parce qu'on y est forcé, pas parce qu'on le choisit.

---

## Conclusion

Si vous devez ouvrir un fichier XD, faites-le. Livrez. Encaissez. Puis proposez une migration complète vers Figma dès le prochain sprint.
